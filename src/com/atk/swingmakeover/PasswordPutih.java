 ...
 * @author dicky-java
 */
public class PasswordPutih extends JPasswordField{
    private static final long serialVersionUID = -1L;

    public PasswordPutih() {
        setOpaque(false);
...
@Override
      ...
      {
          PasswordPutih.this.setCursor(Cursor.getPredefinedCursor(2));
      }

@Override
       public void mouseExited(MouseEvent e)
      {
       PasswordPutih.this.setCursor(Cursor.getPredefinedCursor(0));
      }
   });
    }
