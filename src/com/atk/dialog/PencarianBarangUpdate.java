 ...
 * @author dicky-java
 */
public class PencarianBarangUpdate extends javax.swing.JDialog implements DocumentListener{
    ...
    private void btn_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_addActionPerformed
        ...
        for(CariBarang cb: barang){
            if(cb.getJumlah()==0){
                ...
                valid=valid+1;
                if(cb.isPilih()==true){
                    barangDao.kurangJumlahStok(cb.getJumlah(), cb.getBarang());
                }
            }
        }
