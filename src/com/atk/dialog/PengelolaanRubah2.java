...
public class PengelolaanRubah2 extends javax.swing.JDialog {
    ...
    public PengelolaanBarangDetil rubahData(PengelolaanBarangDetil barangDetil1){
        ...
        txt_jmlsementara.setText(String.valueOf(barangDetil1.getJumlah()));
    ...
    private void initComponents() {
        ...
        txt_jmlsementara = new javax.swing.JTextField();
        ...
        txt_jmlsementara.setText("jTextField1");
    ...
    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanActionPerformed
        ...
        int jumlah2 = Integer.valueOf(txt_jmlsementara.getText());
        int total = 0;
        if(jumlah==0 || cbo_jumlah.getSelectedIndex()==0){
            ...
            int jumlah11 = Integer.valueOf(txt_total.getText());
            ...
            if(jumlah1 >= jumlah11){
                ...
                if(jumlah > jumlah2){
                    ...
                    barangDao.kurangJumlahStok(total, barangDetil.getBarang());
                }else if(jumlah2 > jumlah){
                    total = jumlah2 - jumlah;
                    barangDao.tambahJumlahStok(total, barangDetil.getBarang());
                }
                dispose();
            }
        }
    ...
    private javax.swing.JTextField txt_jmlsementara;
