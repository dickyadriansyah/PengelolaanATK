 ...
 * @author dicky-java
 */
public class PanelLaporanTambah extends javax.swing.JPanel {

    private TambahBarangService tambahBarangdao=new TambahBarangDao();
    private Image image;
    
    public PanelLaporanTambah() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txt_tglAwal, javax.swing.GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
    ...
    private void btn_cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cetakActionPerformed
        ...
        if(txt_tglAwal.getDate()==null){
            ...
            List<ReportTambahBarang> reportTambahBarangs = tambahBarangdao.getReportTambahBarangs(txt_tglAwal.getDate(), txt_tglAKhir.getDate());
            if(!reportTambahBarangs.isEmpty()){
                try {
                    HashMap map=new HashMap();
                    map.put("logo", image);
                    JasperPrint jPrint=JasperFillManager.fillReport(this.getClass().getClassLoader().
                            getResourceAsStream("com/atk/laporan/TambahBarangBulanRpt.jasper"), map, new JRBeanCollectionDataSource(reportTambahBarangs));
                    JRViewer jrv=new JRViewer(jPrint);
                    TampilReport report=new TampilReport("Laporan Penambahan Barang", jrv);
                } catch (JRException ex) {
                    Logger.getLogger(PanelLaporanTambah.class.getName()).log(Level.SEVERE, null, ex);
                }
            }else{
